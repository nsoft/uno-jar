...
public class Test extends Testable {
	...
	public void testClassLoader() throws ClassNotFoundException {
		...
		String name = "com.needhamsoftware.unojar.example.util.Util";
		...
		try {
			name = "com.needhamsoftware.unojar.example.util.NonExistent";
			System.out.println("testClassLoader(): loading " + name);
			testLoader.loadClass(name);
    ...
    public void testServices() throws IOException {
        ...
        Enumeration services = loader.getResources("META-INF/services/com.needhamsoftware.unojar.services.IHelloService");
        int count = 0;
